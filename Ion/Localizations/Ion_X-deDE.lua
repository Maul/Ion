...
L.BARTYPES_USAGE = [=[Gebrauch: |cffffff00/ion create <Typ>|r
]=]
...
L.BETA_WARNING = [=[Danke, dass Sie Ion installiert haben!!!

Ion ist derzeit in einer "|cffffff00Betatest|r" Phase.
...
Das bedeutet, dass nicht alle Features vorhanden sind und es Bugs geben könnte. Aber größtenteils ist Ion in einem nutzbaren und stabilen Zustand.

Benutze Ion im Moment nur, wenn es nicht stört, dass gelegentlich Bugs auftreten oder nicht alles machbar ist wie mit Macaroon =)

-Maul]=]
L.BINDER_NOTICE = [=[Ion Tasten Zuweiser
...
L.CUSTOM_OPTION = [=[
Für eigene Zustände, fügen Sie den gewünschten Zustandstext ein (|cffffff00/ion state custom <Zustandstext>|r) wobei <Zustandstext> eine durch Semikolons getrennte Liste von Bedingungen ist
...
L.SLASH_CMD26_DESC = [=[Wechsle einen Aktionszustand für die Aktuelle Leiste (|cffffff00/ion state <Zustand>|r).
    Gebe |cffffff00/ion statelist|r ein für gültige Zustände]=] -- Needs review
L.SLASH_CMD27 = "Vis" -- Needs review
L.SLASH_CMD27_DESC = [=[Wechsle Sichtbarkeitszustand für die aktuelle Leiste (|cffffff00/ion vis <Zustand> <index>|r)
|cffffff00<index>|r = "show" | "hide" | <num>.
Beispiel: |cffffff00/ion vis paged hide|r versteckt alle mit Seiten
Beispiel: |cffffff00/ion vis paged 1|r wechselt Sichtbarkeit wenn der Zustandsverwalter auf Seite 1 ist]=] -- Needs review
...
L.SLASH_CMD2_DESC = [=[Erzeuge eine leere Leiste des angegebenen Typs (|cffffff00/ion create <Typ>|r)
    Gebe |cffffff00/ion bartypes|r ein für eine Liste der verfügbaren Typen]=] -- Needs review
...
L.SLASH_HINT1 = [=[
/ion |cff00ff00<Befehl>|r <Optionen>]=] -- Needs review
L.SLASH_HINT2 = [=[
Befehlsliste -
]=] -- Needs review
